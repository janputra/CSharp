...
namespace Swing_1
{
    public partial class Form1 : Form
    {
        ...
        double[] a1_last = new double[1000];
        double[,] a1 = new double[100, 10000];
        double[,] dw3 = new double[1000, 1000];
        double[,] dw2 = new double[1000, 1000];
        double[,] dw1 = new double[1000, 1000];
        ...
        double[] s_last3 = new double[1000];
        double[] s_last2 = new double[1000];
        double[] s_last1 = new double[1000];
        double[,] a3 = new double[100, 10000];
        double[] a2_last = new double[1000];
        double[,] a2 = new double[100, 10000];
        double[] es1 = new double[1000];
        double[] es2 = new double[1000];
        double[] p = new double[1000];
        double[] x_last = new double[1000];
        ...
        int inersia, jml_input, gain, jml_output, hidden1, hidden2, looping, jj, m, n, o, r, freq, epo, epoch, cek;
        double  a, sse, t, bfr, n1, n2, n3, err, deg,  tt2, c, tt1, tt0, kons, alpha, momentum, error0, error1, error2, error3, error4, perf;
        double D_err, I_err, last_err, Kp, Kd, Ki, PID;
        double g = 9.8;
        double ma = 20;
        ...
        double deg_tar;
        double xMax = 50;
        int posx1, posy1, posx2, posy2, prevx, prevy1, prevy2;
        Pen black = new Pen(Color.Black);
        Pen red = new Pen(Color.Red);

        private void btnStart_Click(object sender, EventArgs e)
        {
            posx1 = 0; posy1 = 0; prevx = 0; prevy2 = 0;
            scale = 5;
